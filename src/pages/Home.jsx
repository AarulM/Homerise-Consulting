...
const services = [
  {
    ...
    body: 'Done-for-you ad creative, copy, and targeting built to put your roofing business in front of homeowners ready to buy.',
    featured: true,
  },
  {
  ...
  },
  {
    ...
    body: 'Climb the local search results so homeowners find you first when they search for a roofer in your area.',
  },
  {
    title: 'Google Business Profile Management',
    body: 'A fully optimized, review-rich profile that wins the map pack and drives free local calls.',
  },
  {
    title: 'Google Ads Management',
    body: 'High-intent search campaigns that capture homeowners actively looking to hire a roofer right now.',
  },
  {
    title: 'AI Voice Agents',
    body: 'An add-on AI agent that answers and qualifies inbound calls 24/7 so you never miss a lead again.',
    badge: 'Add-on',
  },
  {
    title: 'Social Media Management',
    body: 'Consistent, professional posting that builds trust and keeps your roofing brand top of mind.',
  },
  {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-navy/10 bg-white shadow-card">
      <button
        ...
        aria-expanded={open}
      >
        <span className="text-base font-bold text-navy sm:text-lg">{q}</span>
        <svg
          viewBox="0 0 24 24"
      ...
      <div className={`grid transition-all duration-300 ${open ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'}`}>
        <div className="overflow-hidden">
          <p className="px-6 pb-6 text-base leading-relaxed text-ink/70">{a}</p>
        </div>
      </div>
    </div>
  )
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-white">
        <div
          ...
          style={{
            background:
              'radial-gradient(70% 60% at 50% -10%, rgba(37,99,235,0.10) 0%, rgba(37,99,235,0) 60%), linear-gradient(180deg, #FFFFFF 0%, #F8F9FA 100%)',
          }}
        />
        <div className="container-x px-5 pb-16 pt-16 text-center sm:px-8 md:pb-24 md:pt-24">

          <h1 className="mx-auto mt-7 max-w-4xl text-4xl font-extrabold leading-[1.08] tracking-tight text-navy sm:text-5xl md:text-6xl">
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link to="/book" className="btn-cta w-full px-7 py-3.5 text-base sm:w-auto">
          ...
          {/* Stat boxes */}
          <div id="results" className="mx-auto mt-16 grid max-w-4xl gap-5 sm:grid-cols-3 sm:scroll-mt-24">
            {stats.map((s) => (
              <div
                key={s.label}
                className="rounded-2xl border border-navy/10 bg-white p-7 text-left shadow-card transition-shadow duration-200 hover:shadow-card-hover"
              >
                <div className="text-4xl font-extrabold tracking-tight text-navy">{s.value}</div>
                <div className="mt-2 text-base font-bold text-ink">{s.label}</div>
                <div className="mt-1 text-sm text-ink/60">{s.sub}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-5 pb-4 sm:px-8">
        <div className="container-x">
          <div className="relative overflow-hidden rounded-2xl bg-navy px-7 py-8 shadow-card-hover md:px-12 md:py-10">
            <div
            ...
            <div className="relative flex flex-col items-center gap-5 text-center md:flex-row md:gap-7 md:text-left">
              <span className="flex h-14 w-14 flex-none items-center justify-center rounded-2xl bg-electric/20 text-electric ring-1 ring-electric/40">
              ...
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-electric">Our Guarantee</p>
                <p className="mt-1 text-xl font-extrabold leading-snug text-white sm:text-2xl">
                  If we miss the target, we work free until we hit it.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-x">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {steps.map((step) => (
              <div
                key={step.n}
                className="relative rounded-2xl border border-navy/10 bg-white p-8 shadow-card transition-all duration-200 hover:-translate-y-1 hover:shadow-card-hover"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-electric/10 text-lg font-extrabold text-electric">
                  {step.n}
                </div>
      ...
      {/* =========================== SERVICES ============================ */}
      <section id="services" className="section scroll-mt-24 bg-subtle">
        <div className="container-x">
          <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {services.map((svc) => (
              <div
                key={svc.title}
                className={`group relative flex flex-col rounded-2xl border bg-white p-6 shadow-card transition-all duration-200 hover:-translate-y-1 hover:shadow-card-hover ${
                  svc.featured ? 'border-electric/30 ring-1 ring-electric/20' : 'border-navy/10'
                }`}
              >
                {svc.featured && (
                  <span className="absolute right-4 top-4 rounded-full bg-electric/10 px-2.5 py-1 text-[11px] font-bold uppercase tracking-wide text-electric">
                    Core
                  </span>
                )}
                {svc.badge && (
                  <span className="absolute right-4 top-4 rounded-full bg-navy/10 px-2.5 py-1 text-[11px] font-bold uppercase tracking-wide text-navy">
                    {svc.badge}
                  </span>
                )}
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-navy/5 text-navy transition-colors group-hover:bg-electric/10 group-hover:text-electric">
                  <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2.2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <h3 className="mt-5 text-lg font-bold text-navy">{svc.title}</h3>
      ...
      <section id="pricing" className="section scroll-mt-24">
        <div className="container-x">
          ...
          <div className="mx-auto mt-12 max-w-3xl overflow-hidden rounded-3xl border border-navy/10 bg-white shadow-card-hover">
            <div className="grid md:grid-cols-2">
              <div className="bg-navy p-9 text-white md:p-10">
                <span className="inline-block rounded-full bg-electric/20 px-3 py-1 text-xs font-bold uppercase tracking-widest text-electric ring-1 ring-electric/40">
                  Growth Plan
                </span>
                <div className="mt-6 flex items-end gap-1">
                  <span className="text-5xl font-extrabold tracking-tight">$3,000</span>
                  <span className="mb-1.5 text-lg font-semibold text-white/60">/month</span>
                </div>
                <p className="mt-4 text-base leading-relaxed text-white/70">
                  Done-for-you Facebook ads + lead qualification, built to add 6–8 booked roofing
                  jobs every month.
                </p>
                <Link to="/book" className="btn-cta mt-8 w-full">
                  Book a Strategy Call
                </Link>
                <p className="mt-4 text-center text-sm text-white/50">No long-term contract · Cancel anytime</p>
              </div>

              <div className="p-9 md:p-10">
                <p className="text-sm font-bold uppercase tracking-widest text-ink/40">What's included</p>
      ...
      {/* ============================== FAQ ============================== */}
      <section id="faq" className="section scroll-mt-24 bg-subtle">
        <div className="container-x">
          <div className="mx-auto max-w-2xl text-center">
      ...
      <section className="section">
        <div className="container-x">
          <div className="relative overflow-hidden rounded-3xl px-7 py-16 text-center md:px-12 md:py-20">
            <div
            ...
            <div className="mt-9">
              <Link to="/book" className="btn-cta px-8 py-4 text-lg">
                Book a Strategy Call
              </Link>
            </div>
